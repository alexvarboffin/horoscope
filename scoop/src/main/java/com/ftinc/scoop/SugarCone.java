...
public class SugarCone {
     ...
     *
     */
    private final SparseArray<Topping> mToppings = new SparseArray<>();
    ...
    public SugarCone bindStatusBar(AppCompatActivity activity, int toppingId) {
        return bindStatusBar(activity, toppingId, null);
    }

    public SugarCone bindStatusBar(AppCompatActivity activity, int toppingId, @Nullable Interpolator interpolator) {
